...
ganancia extra de la tienda.*/
    ...
    public static void main(String[] args) {
        ...
        float precioFinal = 0, metrosTela=0, costoTotalTela=0, costoManoObra, ganancia, extraPorTalle = 0, porcentajeManoObra=0;
        ...
        switch (talle){
            case 32:
            case 36:
                extraPorTalle = (costoTotalTela + costoManoObra) * .04f;
        }

        ganancia =  costoTotalTela + costoManoObra + extraPorTalle * .3f;
        precioFinal = costoTotalTela + costoManoObra + ganancia + extraPorTalle;
