...
public class Ejercicio08 {
    //8.	Se tiene un arreglo de 15 filas y 12 columnas. Realice un
    // algoritmo que permita leer el arreglo y que calcule y presente
    // los resultados siguientes:
    //El menor elemento del arreglo; la suma de los elementos de las
    // cinco primeras filas del arreglo; y el total de elementos negativos
